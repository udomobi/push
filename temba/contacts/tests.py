...
class ContactFieldTest(TembaTest):
    ...
    def test_json(self):
        ...
        self.assertEqual(response_json[12]['label'], 'GCM identifier')
        self.assertEqual(response_json[12]['key'], 'gcm')
        self.assertEqual(response_json[13]['label'], 'WebSocket identifier')
        self.assertEqual(response_json[13]['key'], 'ws')
