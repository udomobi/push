...
from .models import PLIVO_AUTH_ID, PLIVO_AUTH_TOKEN, PLIVO, BLACKMYNA, SMSCENTRAL, VERIFY_SSL, JASMIN, FACEBOOK, SEND_BODY, TWIML_API
...
from .models import DEFAULT_SEND_BODY, _GCM, WHATSAPP
